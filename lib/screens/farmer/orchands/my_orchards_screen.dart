            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Stats Row — uses Wrap to prevent overflow
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: [
                      _buildStatChip(
                        Iconsax.ruler,
                        "${orchard.areaSize} ${orchard.areaUnit}",
                        Colors.blue.shade50,
                      ...
                      if (orchard.soilType.isNotEmpty)
                        _buildStatChip(
                          Iconsax.category,
                          orchard.soilType,
                  ...
                  Container(
                    ...
                    child: Text(
                      '${orchard.fruitType}${orchard.variety.isNotEmpty ? ' (${orchard.variety})' : ''}',
                      style: TextStyle(
                        fontSize: 13,
